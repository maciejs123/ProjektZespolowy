...
private:
	...
	Mat fly1;
	Mat fly2;
	Mat mask1, mask2, mask3, maskj1, maskj2, maskf1, maskf2;
	bool sideLeft;
	bool isInAir;
	bool doubleJump;
	int posX;
...
public:
	Mat climb1;
	player();
	player(string c1, string c2, string c3, string j1, string j2, string f1, string f2, int x, int y, bool air, bool side, bool djump);
